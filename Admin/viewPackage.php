                    ...
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li class="active">
                                ...
                                <a href="#" class="fa fa-fw fa-dashboard">Package List</a>
                            </li>
                             <li class="active">
                                <i class="fa fa-dashboard"></i> 
                                <a href="addPackage.php" class="fa fa-fw fa-dashboard">Add Package</a>
                            </li>
                        </ol>
                    </div>
                </div>
						...
						while($row = mysql_fetch_array($sql)){
							...
							<tr>
							  ...
							  <td> 	<?php echo $package_description; ?> </td>
                                                          ...
                                                          <td><a href="updatePackage.php?package_id=<?php echo $package_id ; ?>" class="btn btn-success">Update</a></td>
                                                          <td><a href="deletePackage.php?package_id=<?php echo $package_id ; ?>" class="btn btn-danger">Delete</a></td>
